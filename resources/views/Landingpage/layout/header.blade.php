                        ...
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="{{ url('  ') }}">Profile</a>
                                    <ul>
                                        <li><a href="{{ route('profile.tentangBumdes') }}">Tentang BUMDes</a>
                                        </li>
                                        <li><a href="{{ route('profile.visiMisi') }}">Visi & Misi</a></li>
                                        <li><a href="{{ route('profile.strukturorganisasi') }}">Struktur
                                                Organisasi</a></li>
                                        <li><a href="{{ route('profile.dasarhukum') }}">Dasar Hukum</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('landingpage.layanan') }}">Layanan Kami</a>
