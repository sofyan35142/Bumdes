                                    ...
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="{{ url('  ') }}">Layanan Kami</a>
                                            <ul>
                                                ...
                                                <li><a href="{{ url('service-details') }}">Pertanian & Peternakan</a></li>
                                                <li><a href="{{ url('service-details-2') }}">Penyewaan Aset Desa</a></li>
                                                <li><a href="{{ url('service-details-3') }}">Pariwisata Desa</a></li>
                                                <li><a href="{{ url('service-details-4') }}">Air Bersih / PAM Desa</a></li>
