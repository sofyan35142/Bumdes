...
<body>
                    ...
                    @foreach ($unggulanlist as $unggulan)
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one wow fadeInUp animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="{{ route('home.detailunggulan', $item->id) }}"><img
                                                    src="{{ asset('foto layanan unggulan/' . $unggulan->foto_layanan) }}"
                                                    alt=""></a></figure>
                                        <figure class="overlay-image"><a href="{{ route('home.detailunggulan', $item->id) }}"><img
                                                    src="{{ asset('foto layanan unggulan/' . $unggulan->foto_layanan) }}"
                                                    alt=""></a></figure>
                                    </div>
                                    <div class="lower-content">
                                        <h3><a href="{{ route('home.detailunggulan', $item->id) }}">{{ $unggulan->nama_layanan }}</a></h3>
                                        <div
                                            style="
        display: -webkit-box;
        -webkit-line-clamp: 3;
    ...
    ">
                                        ...
                                        <div class="btn-box"><a href="{{ route('home.detailunggulan', $item->id) }}"
