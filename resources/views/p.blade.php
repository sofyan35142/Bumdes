...
<!-- Mirrored from themesbrand.com/minible/layouts/tables-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Jun 2025 07:29:58 GMT -->
<head>
        ...
        <link href="{{asset('Adminpage/assets/libs/admin-resources/rwd-table/rwd-table.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
        ...
        <!-- Responsive Table js -->
        <script src="{{asset('Adminpage/assets/libs/admin-resources/rwd-table/rwd-table.min.js')}}"></script>

        <!-- Init js -->
        <script src="{{asset('Adminpage/assets/js/pages/table-responsive.init.js')}}"></script>
...
<!-- Mirrored from themesbrand.com/minible/layouts/tables-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Jun 2025 07:29:59 GMT -->
</html>
