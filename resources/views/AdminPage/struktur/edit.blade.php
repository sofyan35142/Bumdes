                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Edit Anggota Struktur Organisasi</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">Perbarui data anggota struktur organisasi BUMDes.</p>

                                    <form action="{{ route('admin.struktur.update', $data->id) }}" method="POST"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="number" name="urutan" id="urutan"
                                                    value="{{ old('urutan', $data->urutan) }}" min="1" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="mt-3">
                                                    <img id="preview-img" src="{{ asset($data->foto) }}" alt="Foto Lama"
