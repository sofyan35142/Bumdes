                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Form Tambah Jenis Layanan</h4>
                                    <p class="card-title-desc">Silakan isi data jenis layanan baru di bawah ini.</p>

                                    <form action="{{ route('admin.jenisLayanan.store') }}" method="POST">
                                        @csrf
                                        {{-- Nama Layanan --}}
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <select name="satuan_sewa" id="satuan_sewa" class="form-select"
                                                    ...
                                                    <option value="" disabled
                                                        {{ old('satuan_sewa') ? '' : 'selected' }}>-- Pilih Satuan --
                                                    </option>
                                                    <option value="hari"
                                                        {{ old('satuan_sewa') == 'hari' ? 'selected' : '' }}>Hari
                                                    </option>
                                                    <option value="bulan"
                                                        {{ old('satuan_sewa') == 'bulan' ? 'selected' : '' }}>Bulan
                                                    </option>
                                                </select>
                                                @error('satuan_sewa')
                                                    <small class="text-danger">{{ $message }}</small>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="harga_sewa" id="harga_sewa"
                                                    class="form-control currency" value="{{ old('harga_sewa') }}"
                                                    required>
                                                @error('harga_sewa')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="beban_perbulan" id="beban_perbulan"
                                                    class="form-control currency" value="{{ old('beban_perbulan') }}"
                                                    required>
