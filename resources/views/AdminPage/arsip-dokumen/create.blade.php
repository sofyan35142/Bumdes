                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Tambah Arsip Dokumen</h4>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control @error('nik') is-invalid @enderror"
                                                    type="number" id="nik-input" name="nik"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control @error('gambar') is-invalid @enderror"
                                                    ...
                                                    onchange="previewImage(this, 'preview-gambar')" required>
                                                @error('gambar')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <img id="preview-gambar"
                                                        src="https://via.placeholder.com/150x200?text=Belum+Ada+Gambar"
                                                        alt="Preview Gambar" width="150"
                                                        class="rounded shadow-sm border">
                                                </div>
                                                <div class="form-text mt-2">Unggah file dokumen (JPG, JPEG, PNG max)
                                                </div>
                                            </div>
                                        </div>
                                        {{-- Tombol Submit --}}
